		...
		options: {
			storySort: {
				...
				order: [
					...
					'Design Tokens',
					['Introduction', 'Utilisation', 'Couleurs', 'Couleurs Amelipro', 'Typographie', 'Styles typographiques', 'Conteneurs de page', 'Espacements', 'Arrondis', 'Elévations'],
					'Composants',
					...
					[
						...
						'Composants Vuetify', ['Introduction', 'VBreadcrumbs', 'VBtn', 'VCard', 'VCarousel', 'VOtpInput', 'VSkeletonLoader', 'VStepper', 'VSwitch', 'VTooltip'],
					],
