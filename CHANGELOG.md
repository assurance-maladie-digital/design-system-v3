...
|--------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| - TableToolbar: fix headers [`#693`](https://github.com/assurance-maladie-digital/design-system-v3/pull/693)       | - DatePicker: improve header and buttons [`#681`](https://github.com/assurance-maladie-digital/design-system-v3/pull/681)
| - DatePicker: improve ranges [`#684`](https://github.com/assurance-maladie-digital/design-system-v3/pull/684)      | - Add tokens (fonts) [`#692`](https://github.com/assurance-maladie-digital/design-system-v3/pull/692)
...
|                                                                                                                    | - DatePicker: add components management and navigation [`#582`](https://github.com/assurance-maladie-digital/design-system-v3/pull/582)
|                                                                                                                    | - Add SyTable / SyServerTable components [`#615`](https://github.com/assurance-maladie-digital/design-system-v3/pull/615)
