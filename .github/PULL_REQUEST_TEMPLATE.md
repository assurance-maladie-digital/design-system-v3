...
| **Accessibilité spécifique au composant/template**                                                   | **Accessibilité spécifique**                                                                                              |
...
|                                                                                                      | **Fusion de composants/templates**                                                                                        |
|                                                                                                      | - [ ] Le composant n'induit pas de régression dans le composant Synapse, PA ou AP                                         |
|                                                                                                      | - [ ] Ajout des stories propre au thème (penser à filter le menu/props si nécessaire)                                     |
|                                                                                                      | - [ ] Ajouter un message dans le composant déprécié avec un lien vers le nouveau                                          |