...
>
	...
	<CriteriaSection>
		<CriteriaCard title="Images et alternatives textuelles">
			<ul>
		...
		<CriteriaCard title="Captcha audio et contrôles">
			<ul>
		...
		<CriteriaCard title="Formulaires et champs de saisie">
			<ul>
		...
		<CriteriaCard title="Boutons d'action et navigation">
			<ul>
		...
		<CriteriaCard title="Alertes et messages d'erreur">
			<ul>
