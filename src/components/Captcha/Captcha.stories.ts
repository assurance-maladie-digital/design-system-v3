...
export default {
	...
	argTypes: {
		...
		'locales': {
			description: 'Surcharge des chaînes affichées à l\'utilisateur (libellés, textes alternatifs et messages du captcha). Les valeurs par défaut sont définies dans le fichier `locales.ts` du composant.',
			control: 'object',
			table: {
