...
<CriteriaSection>
	<CriteriaCard title="Structure sémantique" icon="">
		<ul>
			...
			<li><strong>Relations</strong> : <code>aria-controls</code> relie l’enveloppe activatrice du champ readonly au <code>dialog</code> lorsqu’il est ouvert; <code>aria-owns/expanded/haspopup</code> ne sont pas surchargés sur l’input natif.</li>
