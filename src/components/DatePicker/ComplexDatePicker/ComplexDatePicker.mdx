...
La props `useCombinedMode` permet de combiner le calendrier et la saisie manuelle.


<Canvas story={{height: '550px'}} of={DatePickerStories.Default}/>

## Props, événements et méthodes exposées utilisables dans le mode combiné du DatePicker avec la props `useCombinedMode`:
