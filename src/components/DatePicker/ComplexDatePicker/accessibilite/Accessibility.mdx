...
<CriteriaSection>
	<CriteriaCard title="Structure sémantique" icon="">
		<ul>
			...
			<li><strong>Panneau</strong> : calendrier exposé comme un vrai <code>dialog</code> modal, contenant la grille de jours et les actions associées.</li>
			<li><strong>Relations</strong> : l’activateur référence le dialog via <code>aria-controls</code> quand ouvert; le dialog est nommé via <code>aria-labelledby</code> sur son heading visible.</li>
