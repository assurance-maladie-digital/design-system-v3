...
<CriteriaSection>
	<CriteriaCard title="Structure sémantique" icon="🔍">
		<ul>
			<li><strong>Champ</strong> : conteneur <code>role="combobox"</code> qui expose <code>aria-controls</code> et <code>aria-expanded</code>; champ de saisie interne en <code>textbox</code> (DateTextInput) avec libellé dynamique.</li>
