...
<div className="sb-unstyled" style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '30px' }}>
  <div 
    ...
    onClick={() => linkTo('Composants/Formulaires/DatePicker/DatePicker')()}
  >
    <h3 style={{ marginTop: 0, marginBottom: '10px', color: '#1976d2' }}>Mode Calendrier</h3>
    <p>Mode standard : calendrier interactif pour choisir manuellement une ou plusieurs dates.</p>
  ...
  >
    ...
    <p>Un champ de saisie avec formatage automatique intelligent, sans calendrier (propriété <code>noCalendar</code>).</p>
    <div style={{ marginTop: '10px', color: '#666' }}>
      <strong>Idéal pour :</strong>
      <ul style={{ marginLeft: '20px', marginTop: '5px' }}>
  ...
  >
    ...
    <p>Combine le calendrier interactif et la saisie manuelle avec formatage (propriété <code>useCombinedMode</code>).</p>
    <div style={{ marginTop: '10px', color: '#666' }}>
      <strong>Idéal pour :</strong>
      <ul style={{ marginLeft: '20px', marginTop: '5px' }}>
