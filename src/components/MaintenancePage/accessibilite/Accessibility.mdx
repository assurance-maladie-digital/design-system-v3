...
<div class="mt-2">
    ...
    <CriteriaSection>
        <CriteriaCard icon="🔍" title="Structure sémantique">
            <ul>
                ...
                <li><strong>Prop</strong> <code>uniqueId</code> : permet de définir un identifiant unique sur le conteneur, facilitant le ciblage par <code>aria-labelledby</code> ou <code>aria-describedby</code> depuis d'autres éléments</li>
            </ul>
        </CriteriaCard>
    ...
    <BestPracticesSection>
        <ul>
            ...
            <li>Utiliser <code>unique-id</code> pour permettre à d'autres éléments de référencer la page de maintenance via <code>aria-labelledby</code> ou <code>aria-describedby</code></li>
        </ul>
    </BestPracticesSection>
