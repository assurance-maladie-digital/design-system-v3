...
Le composant permet d'appliquer des filtres sur les colonnes. Vous pouvez définir des filtres personnalisés pour chaque colonne en utilisant la prop `show-filters`.
<Canvas of={SyTable.FilterByText} />

Voir d'autres exemples de filtres dans les stories.
