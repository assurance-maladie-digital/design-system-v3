...
Pour permettre a l'utilisateur de personnaliser les categories de cookies acceptés, il est recommandé d'utiliser ce composant en combinaison avec le composant `CookiesSelection`.
