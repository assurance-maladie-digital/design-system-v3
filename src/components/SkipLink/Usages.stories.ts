		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li style="margin-bottom: 5px;">Le composant lien d'évitement est invisible par défaut pour ne pas encombrer l'interface.</li>
                 <li style="margin-bottom: 5px;">Il doit alors être le premier élément dans l'ordre du focus.</li>      
                <li style="margin-bottom: 5px;">Les libellés des liens doivent être clairs et concis tel que "Aller au contenu principal" ou "Passer au menu".</li>                 
                ...
                <div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
                 <ul style="font-size: 13px;margin-left: 20px;">
                 <li style="margin-bottom: 5px;">Utiliser des libellés trop vagues ou trop longs.</li>
                 </ul>
                </VCol>
              </VRow>
			`,
