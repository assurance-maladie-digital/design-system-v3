		...
		return {
			...
			template: `
			  ...
			  <div class="mt-4">
				  ...
				  <p style="color: grey; font-size: 14px">Correctifs associés (<a href="https://github.com/assurance-maladie-digital/design-system/issues/792" target="_blank" style="color:#0C41BD;">issue #792</a>)</p>
			  </div>
            `,
		}
	},
