	...
	},
	{
		...
		items2: [

			{
				...
				subtitle: '11.5 Dans chaque formulaire, les champs de même nature sont-ils regroupés, si nécessaire ? ',
				precision: '11.5.1 Les champs de même nature vérifient-ils l’une de ces conditions, si nécessaire ? '
				...
				link: 'https://accessibilite.numerique.gouv.fr/methode/criteres-et-tests/#11.5.1',
				solution: [{
					info1: '1. Retrouver dans le document les champs de formulaire de même nature (par exemple un groupe de saisie d’informations d’identité, une série de cases à cocher, une saisie de date sur plusieurs champs successifs…) ; ',
					info2: '2. Pour chaque groupe de champs de formulaire de même nature, vérifier que ces champs de même nature sont regroupés : Soit dans un élément <fieldset> ; Soit dans un élément possédant un attribut WAI-ARIA role="group" ;  Soit dans un élément possédant un attribut WAI-ARIA role="radiogroup" ou "group", s’il s’agit d’éléments <input> de type radio ( ou d’éléments possédant un attribut WAI-ARIA role="radio").',
					info3: '3. Si c’est le cas pour chaque groupe de champs de formulaire de même nature, le test est validé.',
				}],
				expertise: ExpertiseLevelEnum.DEV,
			...
			},
			{
				...
				subtitle: '11.7  Dans chaque formulaire, chaque légende associée à un regroupement de champs de même nature est-elle pertinente ? ',
				precision: '11.7.1 Chaque légende associée à un regroupement de champs de même nature est-elle pertinente ? ',
				link: 'https://accessibilite.numerique.gouv.fr/methode/criteres-et-tests/#11.7.1',
				solution: [{
					info1: '1. Retrouver dans le document les groupes de champs de formulaire de même nature ; ',
					info2: '2. Pour chaque groupe de champs de formulaire de même nature ou pour chacun des champs de même nature qui dispose d’une légende, vérifier que le texte de cette légende est pertinent ; ',
					info3: '3. Si c’est le cas pour chaque groupe de champs de formulaire ou pour chacun des champs de même nature, le test est validé.',
				}],
				expertise: ExpertiseLevelEnum.DEV,
...
export const AccessibiliteItemsValidated = [
...

	{
		...
		items2: [
			{
				subtitle: '11.6  Dans chaque formulaire, chaque regroupement de champs de même nature a-t-il une légende ? ',
				precision: '11.6.1 Chaque regroupement de champs de même nature possède-t-il une légende ? ',
				link: 'https://accessibilite.numerique.gouv.fr/methode/criteres-et-tests/#11.6.1',
				solution: [{
					info1: '1. Retrouver dans le document les groupes de champs de formulaire de même nature ; ',
					info2: '2. Pour chaque groupe de champs de formulaire de même nature, vérifier que : '
					...
					info3: '3. Sinon, pour chacun des champs de même nature, vérifier la présence : '
					...
					info4: '4. Si c’est le cas pour chaque groupe de champs de formulaire ou pour chacun des champs de même nature, le test est validé. ',
