		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li>Ce bouton est flottant et situé en bas à droite de la vue navigateur.</li>
                 <li>Faire revenir l'utilisateur en haut de page avec un défilement.</li>
                 <li>Afficher le bouton uniquement après un certain défilement pour ne pas surcharger visuellement l'interface.</li>
                ...
                <div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
                 <ul style="font-size: 13px;margin-left: 4px;line-height: 28px;">
                 <li>Laisser le bouton toujours visible, surtout sur des pages où il est inutile.</li>
                 <li>Faire revenir l'utilisateur en haut de page avec une action brusque (comme un retour immédiat) sans animation fuilde.</li>
                 </ul>
                </VCol>
              </VRow>
			`,
