		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li>Les liens externes s'ouvrent par défaut dans une nouvel onglet pour éviter que l'utilisateur ne quitte accidentellement l'application.</li>
                 <li>Privilégier des libellés informatifs, comme "Accèder à la page de l'URSSAF".</li>                 
                 </ul>
                </VCol>
                ...
                <div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
                 <ul style="font-size: 13px;margin-left: 4px;line-height: 28px;">
                 <li>Evitez les libellés génériques comme "Cliquez-ici" ou "En savoir plus".</li>
                 </ul>
                </VCol>
              </VRow>
			`,
