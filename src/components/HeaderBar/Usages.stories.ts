		...
		return {
			...
			template: `
				...
				<div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
				 ...
				 <li style="margin-bottom: 5px;">Utiliser une largeur maximale de 1712px (container max de 1600px + left-margin (56px) et right-margin (56px)), le header restant centré dans la page.</li>
				 <li style="margin-bottom: 5px;">Utiliser le type de menu le plus adapté au produit : un burger menu pour les produits complexes et le menu en onglet pour les produits à l'arborescence restreinte.</li>                 
				 </ul>
				</VCol>
				...
				<div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
				 <ul style="font-size: 13px;margin-left: 20px;">
				 <li style="margin-bottom: 5px;">Utiliser le menu en onglet si il existe plus de 6 entrées différentes.</li>
				 </ul>
				</VCol>
			  </VRow>
			`,
