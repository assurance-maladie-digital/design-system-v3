		...
		return {
			...
			template: `
			  ...
			  <div class="mt-4">
				  ...
				  <p style="color: grey; font-size: 14px">Correctifs associés (<a href="https://github.com/assurance-maladie-digital/design-system-v3/issues/828" target="_blank" style="color:#0C41BD;">issue #828</a>)</p>
			  </div>
            `,
		}
	},
