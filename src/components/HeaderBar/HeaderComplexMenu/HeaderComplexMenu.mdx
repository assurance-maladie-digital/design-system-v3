...
import * as HeaderComplexMenuStories from "./HeaderComplexMenu.stories";

<Meta of={HeaderComplexMenuStories} />
...
Ce menu s'utilise conjoitement avec les composants `headerMenuSection` et `headerMenuItem` pour structurer le menu.

Un composant `headerMenuSection` peut contenir plusieurs `headerMenuItem`.

Un Composant `headerMenuItem` doit obligatoirement est contenu dans un `headerMenuSection`.


<Canvas of={HeaderComplexMenuStories.Default} />

## API

<Controls of={HeaderComplexMenuStories.Default} />
...
<Source
  ...
  code={`
      ...
      import { HeaderBar, HeaderComplexMenu, HeaderMenuSection, HeaderMenuItem } from '@cnamts/synapse'
      </script>
...
<Canvas of={HeaderComplexMenuStories.Populated} />
...
<Canvas of={HeaderComplexMenuStories.Generated} />
