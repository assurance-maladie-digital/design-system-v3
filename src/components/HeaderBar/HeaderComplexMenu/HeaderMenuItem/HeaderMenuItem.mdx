...
Ce composant doit être utilisé dans un composant `HeaderMenuSection` afin de respecter la structure du menu et de garantir la bonne accessibilité du menu.
...
Pour plus de détails sur le contexte d'utilisation de ce composant, veuillez consulter le composant `HeaderComplexMenu`.
