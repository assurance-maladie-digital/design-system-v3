...
const meta: Meta = {
	...
	argTypes: {
		locales: {
			description: 'Surcharge des chaînes affichées à l\'utilisateur (messages de prévisualisation et de chargement). Les valeurs par défaut sont définies dans le fichier `locales.ts` du composant.',
			control: 'object',
			table: {
