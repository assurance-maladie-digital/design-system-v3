...
Le composant détecte ce cas via la propriété standard `navigator.pdfViewerEnabled` et bascule alors **automatiquement** sur le rendu **pdf.js**, sans configuration ni prop à activer.
