...
{/* func-version-start */}
<p className="func-version-badge">Dernière mise à jour fonctionnelle : V0.0.10-alpha - 14/02/2025</p>
{/* func-version-end */}
{/* a11y-version-start */}
...
- **`@loaded`** — émis quand le PDF est entièrement chargé et rendu (reçoit le nombre de pages).
...
- **Rétrocompatibilité** : `track-consultation` est `false` par défaut → comportement actuel (`<object>`) inchangé. N'a d'effet que sur les fichiers PDF.
