...
>
	...
	<CriteriaSection>
		...
		<CriteriaCard icon="🎨" title="Styles et contrastes">
			<ul>
                <li><strong>Contrastes garantis</strong> : Couleurs de texte adaptées ("colorPrimary" ou "white") selon le thème clair ou sombre (<code>dark</code>) pour répondre aux critères WCAG de contraste.</li>
