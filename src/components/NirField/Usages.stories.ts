		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li style="margin-bottom: 5px;">Indiquer à l'utilisateur le nombre de chiffres.</li>
                 <li style="margin-bottom: 5px;">Donner la possibilité de saisir uniquement des chiffres.</li>
                 <li style="margin-bottom: 5px;">Permettre à l'utilisateur d'effacer sa saisie en cliquant sur un bouton.</li>
				  <li style="margin-bottom: 5px;">Ajouter un tooltip selon la cible, permettant d'indiquer où trouver son numéro de sécurité sociale.</li>
                 <li style="margin-bottom: 5px;">Message d'erreur uniquement pour le NIR et la clé pour des raisons de sécurité.</li>
