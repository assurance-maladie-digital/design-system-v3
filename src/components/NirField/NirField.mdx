...
- Props: `nirType` à complexe : d'après la page [Wikipedia](https://fr.wikipedia.org/wiki/Num%C3%A9ro_de_s%C3%A9curit%C3%A9_sociale_en_France)
  ...
  - 1 chiffre pour le sexe (1 à 8). Les codes **5** et **6** correspondent aux matricules MIG (« migrants de passage » : 5 = masculin, 6 = féminin) et sont donc acceptés en `nirType="complexe"`.
