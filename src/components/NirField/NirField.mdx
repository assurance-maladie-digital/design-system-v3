...
{/* func-version-start */}
<p className="func-version-badge">Dernière mise à jour fonctionnelle : V1.1.1 - 22/06/2026</p>
{/* func-version-end */}
{/* a11y-version-start */}
...
Vous trouverez la liste des rules mises à disposition dans la section [Comment utiliser les rules](/docs/guide-du-dev-formulaires-validation-guide-technique--docs).
