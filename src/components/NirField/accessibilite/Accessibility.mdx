...
<ResourcesSection>
    <ul>
        <li><a href="https://www.accede-web.com/notices/html-et-css/formulaires/regrouper-les-champs-de-meme-nature-avec-fieldset-et-legend/" target="_blank" style={{ color: '#0C41BD' }}>Accede Web – Regrouper les champs de même nature avec fieldset et legend</a></li>
        ...
        <li><a href="https://www.accede-web.com/notices/html-et-css/formulaires/utiliser-aria-describedby-pour-relier-un-champ-a-une-aide-ou-a-un-message/" target="_blank" style={{ color: '#0C41BD' }}>Accede Web – Utiliser aria-describedby</a></li>
    </ul>
</ResourcesSection>
