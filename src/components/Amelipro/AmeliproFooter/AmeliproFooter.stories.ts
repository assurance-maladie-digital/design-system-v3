...
const meta = {
	argTypes: {
		'a11y-event': { description: 'Événement émis au click sur le bouton accessibilité', type: 'void' },
		...
		'about-event': { description: 'Événement émis au click sur le bouton à propos', type: 'void' },
		...
		'cgu-event': { description: 'Événement émis au click sur le bouton CGU', type: 'void' },
		...
		'site-map-event': { description: 'Événement émis au click sur le bouton plan de site', type: 'void' },
...
export const DeprecationNotice = {
	...createDeprecationNotice([
		{ label: 'Footer', url: '/?path=/docs/composants-structure-footerbar--docs' },
	]),
	tags: ['!dev'],
}
