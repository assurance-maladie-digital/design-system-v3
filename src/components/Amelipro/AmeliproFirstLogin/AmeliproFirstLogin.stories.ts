...
const meta = {
	argTypes: {
		...
		'moreInfoHref': { description: 'Empêche la fermeture de la modale en cliquant à l’extérieur ou en appuyant sur echap mais la croix de fermeture reste présente' },
		'moreInfoTo': { description: 'Masque le footer par défaut' },
