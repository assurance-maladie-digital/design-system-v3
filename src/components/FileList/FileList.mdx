...
Le composant `FileList` est utilisé pour afficher une liste de document à téléversé.

<Canvas of={FileListStories.Default} className="bg-backgroundMain"/>
...
<Canvas of={FileListStories.Actions} className="bg-backgroundMain"/>
