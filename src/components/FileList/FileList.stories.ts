...
const meta = {
	...
	showDeleteBtn?: boolean
		...
		'locales': {
			description: 'Surcharge des chaînes affichées à l\'utilisateur (libellés et messages liés aux documents). Les valeurs par défaut sont définies dans le fichier `locales.ts` du composant. La prop accepte un objet partiel : seules les clés renseignées surchargent les valeurs par défaut, le reste est conservé.',
			control: 'object',
			table: {
