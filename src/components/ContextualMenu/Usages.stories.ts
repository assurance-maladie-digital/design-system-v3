...
const itemsToDo = [
	'Utiliser des libellés explicites et représentatifs du contenu.',
	'Rediriger l\'utilisateur vers le contenu ancré avec une animation fluide.',
]

const itemsNotToDo = [
	'Rediriger l\'utilisateur vers le contenu ancré avec une action brusque (comme un retour immédiat) sans animation fluide.',
]
