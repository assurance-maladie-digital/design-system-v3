...
>
    ...
    <DemoSection title="État par défaut">
        <Story of={StatusPageStories.Default} />
    </DemoSection>

    <DemoSection title="Avec lien de retour">
        <Story of={StatusPageStories.WithLink} />
    </DemoSection>

    <DemoSection title="Avec illustration personnalisée">
