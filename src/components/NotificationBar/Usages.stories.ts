		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li style="margin-bottom: 5px;">La barre de notification doit rester affichée jusqu'à ce que l'utilisateur souhaite la fermer.</li>
                 <li style="margin-bottom: 5px;">La barre de notifications doit avoir une largeur adaptée à son contenu (avec une largeur max de ??px).</li>
                ...
                <div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
                 <ul style="font-size: 13px;margin-left: 20px;">
                 <li style="margin-bottom: 5px;">Pas plus de 3 lignes.</li>
                 <li style="margin-bottom: 5px;">Il est techniquement possible de faire disparaitre la barre de notification après un délai mais cette pratique n'est déconseillé pour des raisons d'accessibilité afin de permettre à tout le monde de prendre le temps nécéssaire de lire la notification.</li>
                 </ul>
                </VCol>
              </VRow>
			`,
