...
Le menu burger est généré automatiquement à partir des items passés en props, il utilise en interne le composant `HeaderComplexMenu`.
...
Pour plus de d'information sur la manière de construire un menu avec le composant `HeaderComplexMenu`, vous pouvez consulter la documentation de ce composant.