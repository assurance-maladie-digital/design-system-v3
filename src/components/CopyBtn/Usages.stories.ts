		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li style="margin-bottom: 5px;">Ce bouton est toujours situé à droite de l'élément qu'il permet de copier.</li>
                 <li style="margin-bottom: 5px;">Fournir un feedback clair après l'action (succès ou echec), comme un message "Texte copié avec succès".</li>
                 <li style="margin-bottom: 5px;">Rendez le texte source sélectionnable manuellement au cas où le bouton échoue.</li>
                ...
                <div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
                 <ul style="font-size: 13px;margin-left: 20px;">
                 <li style="margin-bottom: 5px;">Copier du texte sans le consentement de l'utilisateur.</li>
                 <li style="margin-bottom: 5px;">Fournir un feedback ambigu ou absent après une action.</li>
                 </ul>
                </VCol>
              </VRow>
			`,
