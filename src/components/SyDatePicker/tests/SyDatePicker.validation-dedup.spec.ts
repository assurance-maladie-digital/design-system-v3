...
import type { SyDatePickerMode, SyDatePickerMultiple, SyDatePickerRange } from '../types'
...
interface DedupScenario {
	...
	externalValue: Date | SyDatePickerRange | SyDatePickerMultiple
...
describe.each([true, false])('SyDatePicker validation deduplication (isValidateOnBlur: %s)', (isValidateOnBlur) => {
	afterEach(() => {
		vi.useRealTimers()
