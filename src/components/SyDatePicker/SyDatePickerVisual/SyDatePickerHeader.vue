...
<template>
	<div class="sy-date-picker-header">
		<div class="sy-date-picker-header__legend">
			{{ locales.headerSelectDay }}
		</div>
		<div
			:id="props.titleId"
			class="sy-date-picker-header__label visual-picker-header__date"
			:aria-label="localeDate"
		>
			{{ localeDate }}
		</div>
		<div class="sy-date-picker-header__controls">
			<div class="sy-date-picker-header__selector">
				<button
					type="button"
			...
			<div class="sy-date-picker-header__nav-group">
				<button
					type="button"
					class="sy-date-picker-header__nav sy-date-picker-header__nav--prev"
					:disabled="view !== 'days'"
				...
				<button
					type="button"
					class="sy-date-picker-header__nav sy-date-picker-header__nav--next"
					:disabled="view !== 'days'"
...
.sy-date-picker-header__controls {
	display: flex;
	align-items: center;
...
.sy-date-picker-header__selector,
.sy-date-picker-header__nav-group {
	display: flex;
	align-items: center;
	gap: 8px;
}
