...
import type { SyDatePickerMode, SyDatePickerValue } from '../types'

interface UseSyDatePickerTextSyncOptions {
	mode: MaybeRefOrGetter<SyDatePickerMode>
	inputFormat: MaybeRefOrGetter<string>
	separator: MaybeRefOrGetter<string>
	locale: MaybeRefOrGetter<string>
	/** Model ref returned by `defineModel` */
	internalValue: Ref<SyDatePickerValue | undefined>
	...
	onUserValueChange: (value: SyDatePickerValue) => void
}
 ...
 */
export function useSyDatePickerTextSync(options: UseSyDatePickerTextSyncOptions) {
