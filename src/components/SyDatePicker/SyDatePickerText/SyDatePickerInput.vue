<script setup lang="ts">
	...
	const props = withDefaults(defineProps<{
		...
		/** Raw text of the field, owned by SyDatePicker (single source) */
	...
	>
		...
		<template #append>
			...
			<button
				...
				ref="toggleBtn"
				type="button"
				class="sy-date-picker-input__toggle-btn"
...
.error-field .sy-date-picker-input__toggle-btn :deep(svg) {
	color: rgb(var(--v-theme-error, 179, 63, 46));
}

.warning-field .sy-date-picker-input__toggle-btn :deep(svg) {
...
.sy-date-picker-input__toggle-btn:focus-visible {
