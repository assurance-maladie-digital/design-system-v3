...
<div className="header">
  <h1>SyCheckbox</h1>
  <p>Le composant `SyCheckbox` est une case à cocher qui étend le composant `VCheckbox` de Vuetify, conforme au style du Design System et qui respecte les règles d'accessibilité <abbr title="Référentiel Général d'Amélioration de l'Accessibilité">RGAA</abbr>.</p>
</div>
