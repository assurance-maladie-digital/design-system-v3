...
Le composant `CustomTextField` est utilisé pour proposer une alternative au `v-text-field` de Vuetify, conforme au style du design-system et qui  respecte les règles d'accessibilité RGAA.
