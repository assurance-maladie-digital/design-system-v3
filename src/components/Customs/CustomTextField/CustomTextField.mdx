...
Le composant `CustomTextField` est utilisé pour proposer une alternative au `v-textField` de Vuetify, conforme au style du design-system et qui  respecte les règles d'accessibilité RGAA.
