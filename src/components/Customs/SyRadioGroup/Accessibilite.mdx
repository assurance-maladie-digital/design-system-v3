...
<div className="header">
  ...
  <div className="criteria-section">
    ...
    <div className="criteria-card">
      ...
      <ul>
        <li><strong>Rôles ARIA appropriés</strong> : <code>role="radio"</code> pour la case à cocher</li>
  ...
  <div className="tri-state-section">
    ...
    <p>
      Le composant SyRadioGroup prend en charge l'état indéterminé, particulièrement utile pour représenter :
    </p>
    <ul>
  ...
  <div className="parent-child-section">
    ...
    <p>
      Le composant SyRadioGroup permet de créer des relations parent-enfant entre les cases à cocher, où :
    </p>
    <ul>
