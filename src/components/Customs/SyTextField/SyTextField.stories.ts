...
const meta = {
	...
	argTypes: {
		...
		'locales': {
			description: 'Surcharge des chaînes affichées à l\'utilisateur (libellés d\'accessibilité et messages de validation). Les valeurs par défaut sont définies dans le fichier `locales.ts` du composant.',
			control: 'object',
			table: {
