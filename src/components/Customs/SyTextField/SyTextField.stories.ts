...
export const Number: Story = {
	...
	render: args => ({
		...
		template: `
			<div>
				<p class="mb-4">
					Le champ <code>type="number"</code> est rendu en <code>type="text"</code> (+ <code>inputmode="decimal"</code>)
					pour une saisie fiable sur tous les navigateurs. Les boutons +/- et les flèches ↑/↓ incrémentent la valeur
					en respectant <code>step</code>, <code>min</code> et <code>max</code>.
				</p>
				<SyTextField
					v-model="value"
					v-bind="args"
	...
	parameters: {
		docs: {
			description: {
				story: 'Champ numérique avec boutons d\'incrément personnalisés (spinner ↑/↓) et support des attributs step, min et max. L\'incrément est aussi accessible au clavier via les flèches ↑/↓ lorsque le champ a le focus.',
			},
		},
		sourceCode: [
			{
...
export const NumberWithoutSpinButtons: Story = {
	args: {
		modelValue: '42',
		label: 'Quantité',
		type: 'number',
	...
	render: args => ({
		...
		template: `
			<div>
				<p class="mb-4">
					La prop <code>areSpinButtonsHidden</code> masque les boutons d'incrément.
					Le filtrage de la saisie et l'incrément clavier (flèches ↑/↓) restent actifs.
				</p>
				<SyTextField
					v-model="value"
					v-bind="args"
	...
	parameters: {
		docs: {
			description: {
				story: 'Champ numérique sans les boutons d\'incrément (areSpinButtonsHidden), tout en conservant le filtrage de saisie et l\'incrément au clavier.',
			},
		},
		sourceCode: [
			{
