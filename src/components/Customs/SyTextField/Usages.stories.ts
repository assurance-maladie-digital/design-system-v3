		...
		return {
			...
			template: `
                ...
                <div class="d-flex" style="color:#004439; font-weight:bold;"><VIcon :icon="checkIcon"/><p class="font-weight-bold mb-2"> À faire</p></div>
                 ...
                 <li>Indiquer les erreurs en temps réel avec un message explicite (si possible).</li>
                 <li>Respecter un bon constraste entre texte et le fond pour la lisibilité.</li>
                ...
                <div class="d-flex" style="color:#B33F2E; font-weight:bold;"><VIcon :icon="croixIcon"/><p class="font-weight-bold mb-2"> À ne pas faire</p></div>
                 <ul style="font-size: 13px;margin-left: 4px;line-height: 28px;">
                 <li>Utiliser un "input field" simple quand une version spécifique est disponible (phone field, NIR Field).</li>
                 <li>L'utiliser lorsque le texte à saisir est long. Utilisez plutôt le composant textarea.</li>
                 </ul>
                </VCol>
              </VRow>
			`,
