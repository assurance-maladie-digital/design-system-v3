...
Notre système propose trois modes de sélection, chacun adapté à des besoins spécifiques :
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
  ...
  >
    ...
    <h3 style={{ marginTop: 0, marginBottom: '10px', color: '#7b1fa2' }}>SyInputSelect <span style={{ fontSize: '12px', fontWeight: 'normal', color: '#999' }}>(déprécié)</span></h3>
