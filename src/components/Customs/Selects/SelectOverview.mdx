...
<div className="sb-unstyled" style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '30px' }}>
  ...
  >
      <img style={{ width: '40%', height: 'auto', marginLeft: '35%' }} src="/components/sy-select.svg" alt="SyAutocomplete" />
    <h3 style={{ marginTop: 0, marginBottom: '10px', color: '#0c41bd' }}>SyAutocomplete</h3>
    <div>Composant de saisie avec suggestions, permettant de filtrer une liste via la frappe au clavier.</div>
    <div style={{ marginTop: '10px', color: '#666' }}>
      <strong>Idéal pour :</strong>
      <ul style={{ marginLeft: '20px', marginTop: '5px' }}>
        <li>Listes longues (recherche par saisie)</li>
        <li>Expérience de sélection assistée</li>
        <li>Cas où l'utilisateur connaît partiellement la valeur attendue</li>
      </ul>
    </div>
    <div style={{ marginTop: '15px' }}>
      <span style={{ 
...
- Vous avez une liste longue et souhaitez aider l'utilisateur via une recherche par saisie
- Vous avez besoin de suggestions au fil de la frappe (items locaux ou chargés via API)
- L'utilisateur connaît partiellement la valeur attendue (ex: recherche d'une personne, d'un pays)
