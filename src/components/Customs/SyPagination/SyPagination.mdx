import { Canvas, Meta, Controls, Story, Source } from '@storybook/addon-docs/blocks';
...
{/* func-version-end */}
{/* a11y-version-start */}
<p className="a11y-version-badge">Dernière mise à jour accessibilité : V1.0.22 - 02/03/2026</p>
{/* a11y-version-end */}
