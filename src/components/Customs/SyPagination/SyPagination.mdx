...
### Personnalisation du nombre de pages visibles

Le nombre de pages visibles autour de la page courante peut être personnalisé avec la prop `visible`.

<Canvas of={SyPaginationStories.CustomVisiblePages} />
...
<Canvas of={SyPaginationStories.WithInfoText} />
