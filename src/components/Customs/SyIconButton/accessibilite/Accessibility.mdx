	...
	<CriteriaSection>
		<CriteriaCard icon="🔍" title="Structure sémantique">
			<ul>
				...
				<li><strong>Icône décorative</strong> : le <code>v-icon</code> interne est marqué <code>:aria-hidden="true"</code> car le bouton porte déjà le nom accessible via <code>aria-label</code></li>
