...
export const AccessibiliteItemsIndeterminate = [
	{
		...
		subtitle: '5.4 Pour chaque tableau de données ayant un titre, le titre est-il correctement associé au tableau de données ?',

		items2: [
			{
				subtitle: '5.2 Pour chaque tableau de données complexe ayant un résumé, celui-ci est-il pertinent ?',
				precision: '5.2.1 Pour chaque tableau de données complexe ayant un résumé, celui-ci est-il pertinent ?  ',
				link: 'https://accessibilite.numerique.gouv.fr/methode/criteres-et-tests/#5.2.1',
				solution: [{
					info1: '1. Retrouver dans le document les résumés de tableaux de données complexes (tels que déterminés par le test 5.1.1) ;',
					info2: '2. Pour chaque résumé, vérifier que son contenu est pertinent ; ',
					info3: '3. Si c’est le cas pour chaque résumé de tableaux de données complexes, le test est validé.',
				}],
		...
		items: [
			{
				precision: ' 5.4.1 Pour chaque tableau de données ayant un titre, le titre est-il correctement associé au tableau de données ?',
				link: 'https://accessibilite.numerique.gouv.fr/methode/criteres-et-tests/#5.4.1',
				solution: [{
					info1: '1. Retrouver dans le document les tableaux de données pourvus d’un titre ; ',
					info2: '2. Pour chaque titre, vérifier qu’il est fourni au moyen : Soit d’un élément <caption> ; Soit d’un attribut title ; Soit d’un attribut WAI-ARIA aria-label ; Soit d’un attribut WAI-ARIA aria-labelledby référençant un passage de texte.',
					info3: '3. Si c’est le cas pour chaque titre de tableau de données, le test est validé.',
				}],
				expertise: ExpertiseLevelEnum.DEV,
...
export const AccessibiliteItemsValidated = [
	...
	{
		title: 'Catégorie 5 : Tableaux',
		subtitle: '5.7  Pour chaque tableau de données, la technique appropriée permettant d’associer chaque cellule avec ses en-têtes est-elle utilisée (hors cas particuliers) ? ',
		items2: [
			{
				...
				solution: [{
					...
					info2: '2. Pour chaque tableau de données complexe, vérifier qu’un passage de texte permettant de comprendre la nature et la structure du tableau, est présent : Soit dans l’élément <caption> ; Soit dans l’attribut summary de l’élément <table> (dans les versions de HTML et de XHTML antérieures à HTML 5) ; Soit dans un passage de texte lié au tableau avec l’attribut aria-describedby. ',
					info3: '3. Si c’est le cas pour chaque tableau de données complexes, le test est validé.',
				}],
				expertise: ExpertiseLevelEnum.DESIGN,
		...
		items: [
			{
				precision: '5.7.1 Pour chaque contenu de balise <th> s’appliquant à la totalité de la ligne ou de la colonne, la balise <th> respecte-t-elle une de ces conditions (hors cas particuliers) ? '
				...
				link: 'https://accessibilite.numerique.gouv.fr/methode/criteres-et-tests/#5.7.1',
				solution: [{
					info1: '1. etrouver dans le document les tableaux de données ; ',
					info2: '2. Pour chaque en-tête (élément <th>) s’appliquant à la totalité de la ligne ou de la colonne, vérifier que l’élément <th> possède : Soit un attribut id unique ; Soit un attribut scope ; Soit un attribut WAI-ARIA role="rowheader" ou "columnheader". ',
					info3: '3. Si c’est le cas pour chaque en-tête s’appliquant à la totalité de la ligne ou de la colonne, le test est validé.',
				}],
				expertise: ExpertiseLevelEnum.DESIGN,
