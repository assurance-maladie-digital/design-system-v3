        ...
        <script setup lang="ts">
		  ...
		  const selectedDialCodeLabel = computed(() => {
			...
			if (typeof value === 'object' && value !== null) {
				const code = 'code' in value ? String((value as any).code) : ''
				const country = 'country' in value ? String((value as any).country) : ''
	...
	render: (args) => {
		return {
			...
			setup() {
				...
				return { args, modelValue, selectedDialCode, selectedDialCodeLabel, updateSelectedDialCode }
			},
			template: `
				<div class="pa-4">
					<div class="pa-4">
