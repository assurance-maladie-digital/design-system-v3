...
<div className="accessibility-guide">
	...
	<div className="intro-section">
		...
		<p className="intro-text">
			...
			notamment le modèle <a href="https://www.w3.org/WAI/ARIA/apg/patterns/landmark-region/" target="_blank" rel="noopener noreferrer">WAI-ARIA pour les champs de formulaire</a>.
	...
	<div className="best-practices">
		...
		<ul>
			...
			<li>Configurez les attributs <code>autocomplete</code> appropriés (<code>tel-country-code</code>, <code>tel-national</code> ou <code>tel</code>) pour faciliter le remplissage automatique.</li>
