...
>
  <CriteriaSection>
    <CriteriaCard icon="🔍" title="Structure sémantique">
      <ul>
        <li><strong>Labels et champs de fichier</strong> : Utilisation de <code>label</code> et <code>input type="file"</code> pour les champs de téléchargement de fichiers, avec l'attribut <code>accept</code> pour spécifier les types de fichiers acceptés.</li>
        <li><strong>Disabled</strong> : Utilisation de l'attribut <code>disabled</code> sur l'input si le champ est désactivé.</li>
      </ul>
    </CriteriaCard>
