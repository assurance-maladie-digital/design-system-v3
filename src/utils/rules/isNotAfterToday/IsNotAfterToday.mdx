...
<div className="header">
  <h1>Règle de validation `isNotAfterToday`</h1>
  <p>La règle de validation `isNotAfterToday` permet de vérifier qu'une date n'est pas postérieure à la date du jour.</p>
</div>
