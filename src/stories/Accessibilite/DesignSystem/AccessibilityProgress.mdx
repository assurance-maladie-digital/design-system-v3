...
<div className="header">
  ...
  <p>Cette page présente l'état d'avancement de la mise en accessibilité des composants du Design System (hors AmeliPro). Les données présentées ici sont générées automatiquement à chaque mise à jour du script d'audit d'accessibilité.</p>
</div>
              ...
              <tr key={item.componentName}>
                ...
                <td>
                  <span className={`carbon-tag ${item.hasA11yDisabledInStories ? 'tag-red' : 'tag-green'}`}>
                    {item.hasA11yDisabledInStories ? 'Absente' : 'Présente'}
                  </span>
                </td>
                <td>
