...
<Meta title="Accessibilité/Design System/Avancement2" />
...
{(() => {
  ...
  const filteredComponents = statusData.results
          ...
          <th>
            <div className="th-content">
              ...
              <span className="carbon-tooltip-container">
                ...
                <span className="carbon-tooltip-content">Indique si un rapport d'audit manuel a été réalisé pour ce composant.</span>
              </span>
            </div>
          </th>
        </tr>
          ...
          .map((item) => {
            ...
            return (
              <tr key={item.componentName}>
                ...
                <td>
                  <span className={`carbon-tag ${item.hasManualAudit ? 'tag-green' : 'tag-gray'}`}>
                    {item.hasManualAudit ? 'Oui' : 'Non'}
                  </span>
                </td>
              </tr>
            );
