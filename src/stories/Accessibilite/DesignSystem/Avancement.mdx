          ...
          <th>
            <div className="th-content">
              ...
              <span className="carbon-tooltip-container">
                ...
                <span className="carbon-tooltip-content">Version du Design System dans laquelle l'accessibilité de ce composant a été corrigée / mise à jour (issue de l'analyse git de l'historique d'accessibilité).</span>
              </span>
            </div>
          </th>
        </tr>
        ...
        {filteredComponents
          .map((item) => {
            ...
            const getStorybookUrl = (componentName, storybookTitle) => {
              ...
              return `/docs/composants-${category}-${formattedName}--docs`;
            };
