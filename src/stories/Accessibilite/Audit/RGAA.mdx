...
<div className="rgaa-container">
  ...
  <div className="link-buttons">
    <a href="https://www.numerique.gouv.fr/publications/rgaa-accessibilite/#contenu" className="link-card">En savoir plus sur le RGAA</a>
    <a href="https://www.w3.org/WAI/fundamentals/" className="link-card">En savoir plus sur le W3C WAI</a>
    <a href="https://www.numerique.gouv.fr/publications/rgaa-accessibilite/methode-rgaa/criteres/#contenu" className="link-card">Accéder à la liste des critères</a>
  </div>
