...
<ul>
  ...
  <li>
    <strong>Vérifier en continu :</strong> pour s'assurer, tout au long du développement, qu’un niveau intermédiaire d’accessibilité est bien respecté.
  </li>
</ul>

  <p>
    La démarche est réalisée <b>en autonomie par l’équipe de développement</b>. Le kit guide l’auto-évaluation, mais le relevé des non-conformités et la mise en œuvre des corrections relèvent de la responsabilité de l’équipe projet.
  </p>

  <p>
    La restitution consiste à vérifier que l’ensemble des exigences du pré-audit est bien couvert et à limiter au maximum les erreurs détectées par les tests automatisés, notamment avec Tanaguru.
  </p>

  <p>
   Dans le cadre de la preparation d'un audit, les résultats obtenus à l'aide de ce kit doivent être considérés comme un point de départ, et non comme une évaluation finale. Avant correction, le taux de conformité observé se situe généralement entre <b>30 % et 50 %</b>. La correction de l’ensemble des anomalies détectées par le kit permet ensuite d’atteindre le seuil de conformité partielle au sens du RGAA.
  </p>

  <p>
    Un audit, complété si nécessaire par un contre-audit après correction, pourra ensuite confirmer le niveau de conformité atteint.
  </p>
