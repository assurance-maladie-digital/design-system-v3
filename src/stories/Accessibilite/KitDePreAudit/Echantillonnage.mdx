...
<div className="header">
  ...
  <p>Définir un périmètre représentatif pour votre audit d'accessibilité. <br></br> Si aucun audit n’est prévu, utilisez le kit de pré-audit pour vérifier que chacun de vos développements respecte les exigences du RGAA. </p>
</div>
