...
<div className="resources-grid">
  <div className="resource-card">
    ...
    <a href="/?path=/docs/accessibilit%C3%A9-aculturation-sensibilisation-%C3%A0-l-accessibilit%C3%A9-num%C3%A9rique--docs">Découvrir →</a>
  </div>
  ...
  <div className="resource-card">
    ...
    <a href="/?path=/docs/accessibilit%C3%A9-audit-et-contre-audit-introduction--docs">Consulter →</a>
  </div>
</div>
...
<div className="info-section">
  ...
  <p>Pour en savoir plus, vous pouvez consulter <a href="/?path=/docs/accessibilit%C3%A9-design-system-audit-du-design-system--docs">la page dédiée à l'audit d'accessibilité du Design System</a>.</p>
</div>
