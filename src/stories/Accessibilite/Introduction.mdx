...
<div className="info-section">
  ...
  <div className="process-steps">
    ...
    <div className="process-step">
      ...
      <p>Une fois le produit éligible, l'équipe experte du Studio Design réalise un audit et communique à l'équipe-produit un rapport comportant des recommandations. Il pourra être demandé un contre-audit après une phase de corrections pilotée par l'équipe produit.</p>
    </div>
