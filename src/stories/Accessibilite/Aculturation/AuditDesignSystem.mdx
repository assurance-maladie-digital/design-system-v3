...
<figure>
  ...
  <figcaption id="capture-page-accessibilite-alt">Capture d'écran de la page Accessibilité du composant NotificationBar. Celle-ci donne des éléments sur les audits Tanaguru et manuels.</figcaption>
</figure>
