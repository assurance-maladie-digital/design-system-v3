		...
		return {
			...
			template: `
              <div class="mt-12 mb-12">
                  <p>Bienvenue dans notre guide d'aide à la conception, pensé par et pour les équipes <span v-if="theme === 'pa'">de Portail Agent</span><span v-if="theme === 'ap'">d'AmeliPro</span><span v-if="theme === 'cnam'">de la CNAM</span>.</p>
