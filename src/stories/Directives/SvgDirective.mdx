...
<div className="feature-grid">
  ...
  <div className="feature-card">
    <h3> Pour les SVG internes uniquement</h3>
    <p>Le paramètre <code>onlyInner</code> s'utilise lorsque le conteneur porte déjà son propre rôle, son label ou son état ARIA, et que seuls les SVG internes doivent être masqués.</p>
    <div className="info-box" style={{ margin: '1rem 0' }}>
      <p>Avec <code>{'{ onlyInner: true }'}</code>, la directive :</p>
      <ul>
        <li>Supprime <code>role="img"</code> sur chaque SVG interne</li>
        <li>Ajoute <code>aria-hidden="true"</code> sur chaque SVG interne</li>
        <li>Ne modifie aucun attribut du conteneur attaché à la directive</li>
      </ul>
    </div>
  </div>
</div>
...
<div className="feature-grid">
  ...
  <div className="feature-card">
    ...
    <div className="code-example">
      ...
      <!-- Masquer uniquement les SVG internes sans modifier le conteneur -->
      <button
...
<div className="feature-grid">
  <div className="feature-card">
    ...
    <div className="info-box" style={{ margin: '1rem 0' }}>
      <ul>
        ...
        <li><code>onlyInner</code> : <code>boolean</code> - Corrige uniquement les SVG internes sans modifier le conteneur</li>
      </ul>
    </div>
    <div className="code-example">
      ```typescript
  ...
  <div className="feature-card">
    <h3> Option onlyInner</h3>
    <p><code>onlyInner</code> est utile quand la directive est posée sur un composant ou un élément qui gère déjà son accessibilité au niveau du conteneur.</p>
    <div className="info-box" style={{ margin: '1rem 0' }}>
      <ul>
        <li>Le conteneur conserve son <code>role</code>, son <code>aria-label</code>, son <code>aria-checked</code> ou ses autres attributs ARIA</li>
        <li>Les SVG internes deviennent décoratifs pour éviter un double énoncé par les technologies d'assistance</li>
        <li>Cette option convient aux composants complexes comme une checkbox, un bouton ou un champ qui exposent déjà leur état accessible</li>
      </ul>
    </div>
    <div className="code-example">
      ```vue
