...
<Meta title="Guide Du Dev/Démarrage/Configuration du thème" />
...
Pour configurer Vuetify et changer le thème, utilisez `createVuetifyInstance` — consultez la page [createVuetifyInstance](/docs/guide-du-dev-démarrage-createvuetifyinstance--docs) pour le détail complet.
