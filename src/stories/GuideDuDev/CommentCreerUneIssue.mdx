...
Les issues sont un moyen essentiel de suivre les bugs, les améliorations et les nouvelles fonctionnalités dans notre design system.
...
### 1. Allez sur le lien : [créer un rapport de bug](https://github.com/assurance-maladie-digital/design-system-v3/issues/new?template=bug_report.md)

### 2. Choisissez le type d'issue approprié :
- 🐛 Bug Report
- ✨ Feature Request
- 📝 Documentation
- 🔄 Refactoring
...
## Elements à fournir dans une issue
...
Une description claire de ce qui aurait dû se passer.

#### Captures d'écran
Si applicable, ajoutez des captures d'écran pour illustrer le problème.

#### Environnement
- OS: [ex: Windows/Mac/Linux]
- Navigateur: [ex: Chrome, Safari]
- Version du Design System: [ex: 3.0.0]
...
#### Cas d'utilisation
Expliquez comment et pourquoi cette fonctionnalité serait utile.
...
4. **Vérifiez les doublons** : Avant de créer une nouvelle issue, vérifiez si elle n'existe pas déjà en cherchant dans les [rapports existants](https://github.com/assurance-maladie-digital/design-system-v3/issues)
