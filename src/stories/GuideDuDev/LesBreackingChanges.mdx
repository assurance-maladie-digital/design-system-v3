...
Du fait que le design system est distribué en tant que package uniquement et non plus en tant que plugin vue, Le composant `CustomIcon` a été retiré du design system.

Vous devez désormais utiliser le composant [VIcon](https://vuetifyjs.com/en/components/icons/) de Vuetify avec les icons material du package[ @mdi/js](https://www.npmjs.com/package/@mdi/js). Pour des icons personnalisés, importez les sous forme de composant.
