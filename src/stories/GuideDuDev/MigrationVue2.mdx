...
- 1.1 - Téléchargez la stack de migration Starter Kit Synapse

- 1.2 - Copier les pages de votre projet VueJS 2 dans le dossier pages du projet Starter Kit, les composants peuvent placés dans le dossier components
