...
<Meta title="Démarrer/Guide Du Dev/Migration Vue3"/>

# Migrer vers Synapse

Ce guide vous explique comment migrer de la version Bridge (Vue3) du Design System vers Synapse.
...
- 1.2 - Transférez les pages de votre projet du Starter Kit Bridge dans le dossier pages du projet Starter Kit Synapse, les composants peuvent être placés dans le dossier components.

- 1.3 - Identifier les dépendances à conserver dans la nouvelle version.
