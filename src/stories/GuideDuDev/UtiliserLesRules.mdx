...
<div className="header">
  <h1>Utiliser le système de validation</h1>
  <p>Ce guide décrit comment utiliser le système de validation de formulaires du Design System pour créer des validations flexibles et intuitives. </p>
</div>
