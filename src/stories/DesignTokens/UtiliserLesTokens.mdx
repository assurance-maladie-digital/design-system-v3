...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>--v-theme-on-surface</code>, <code>--v-theme-on-surface-variant</code>, <code>--v-theme-on-primary</code>… (<strong>camelCase</strong>)</td>
      <td>Définis par le Design System</td>
      <td>✅ Oui</td>
    </tr>
    <tr>
      <td>Contrastes auto-générés par Vuetify</td>
      <td><code>--v-theme-on-surface</code>, <code>--v-theme-on-surface-bright</code>… (<strong>kebab <code>on-</code></strong>)</td>
