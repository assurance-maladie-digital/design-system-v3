...
<Meta title="Migration/Consignes de migration" />

# Consignes de migration

Guide de migration pour les développeurs.

![drawing](https://digital-design-system.netlify.app/migration.jpg)

*NB:Pour toute question complémentaire sur la migration, vous pouvez vous rapprocher de l'équipe du Design System.*

[](https://digital-design-system.netlify.app/migration-bridge#1-debuter-la-migration)1 - Débuter la migration
-------------------------------------------------------------------------------------------------------------
...
[](https://digital-design-system.netlify.app/migration-bridge#2-migration-du-routeur)2 - Migration du routeur
-------------------------------------------------------------------------------------------------------------
...
Le fichier `app/router.options.ts` est chargé automatiquement par Nuxt, et permet de surcharger les routes par défaut de Nuxt. Pour plus d'informations, voir [cette page de documentation de Nuxt](https://nuxt.com/docs/guide/going-further/custom-routing).
...
[](https://digital-design-system.netlify.app/migration-bridge#3-migration-des-stores-vuex)3 - Migration des stores VueX
-----------------------------------------------------------------------------------------------------------------------
...
[](https://digital-design-system.netlify.app/migration-bridge#4-animations-des-pages)4 - Animations des pages
-------------------------------------------------------------------------------------------------------------
...
[](https://digital-design-system.netlify.app/migration-bridge#5-utilisation-du-script-vue-class-migrator)5 - Utilisation du script [vue-class-migrator](https://github.com/getyourguide/vue-class-migrator)
...
[](https://digital-design-system.netlify.app/migration-bridge#6-migration-des-composants-vuetify)6 - Migration des composants Vuetify
-------------------------------------------------------------------------------------------------------------------------------------

Pour faciliter la migration des composants Vuetify, ce starter kit intègre le plugin [eslint-plugin-vuetify](https://github.com/vuetifyjs/eslint-plugin-vuetify). Il permet de faire remonter certains problèmes tels que des props qui n'existent plus ou dont le nom a changé. Certains changements peuvent être effectués automatiquement.
...
[](https://digital-design-system.netlify.app/migration-bridge#7-migration-de-la-localisation)7 - Migration de la localisation
-----------------------------------------------------------------------------------------------------------------------------
...
[](https://digital-design-system.netlify.app/migration-bridge#8-migration-des-tests-unitaires-et-de-composants)8 - Migration des tests unitaires et de composants
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
